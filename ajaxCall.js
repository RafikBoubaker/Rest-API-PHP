...
$(document).ready(function(){
    $('#postMessage').click(function(e){
        ...
        $.ajax({
            type:"POST",
            url: "/Work folders/OOP php/RESTFUL api/php_rest_myblog/api/post/create.php",
            data: test,
...
//GET REQUEST
  ...
  document.getElementById('getMessage').onclick=function(){
       ...
       req.open("GET", '/Work folders/OOP php/RESTFUL api/php_rest_myblog/api/post/read.php',true);
       req.send();
